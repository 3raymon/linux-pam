...
#define CUSTOM_SHADOW_PATH       34 /* path to custom shadow file, default=/etc/shadow */
#define CUSTOM_PASSWD_PATH       35 /* path to custom passwd file, default=/etc/passwd */
/* -------------- */
...
/* CUSTOM SHADOW PATH*/        {"shadow_path="      _ALL_ON_,                     040000000000, 0},
/* CUSTOM PASSWD PATH*/        {"passwd_path="      _ALL_ON_,                    0100000000000, 0},
};
...
extern char shadow_path[1024] = "";
extern char passwd_path[1024] = "";
